...
source_field = (
    source_ctx.web.default_document_library().fields.get_by_internal_name_or_title(
        field_name
    )
)
...
target_field = target_list.fields.create_field_as_xml(
    source_field.schema_xml
).execute_query()
